...
vectorsfile = '/home/liuxiao/tongji/vectors_200.bin'
paramsfile = '/home/liuxiao/tongji/cnn1/parameters'
validationfile = '/home/liuxiao/tongji/nlpcc_validation'
#vectorsfile = '/opt/exp_data/word_vector_cn/all_dbqa.bin'

#log file
logfile_path = '/home/liuxiao/tongji/cnn1'
...
class QACnn(object):
    def __init__(self,word_embeddings, batch_size, sequence_len, embedding_size, filter_sizes, num_filters, margin_size, learning_rate):
        ...
        # wo_q1 = wo_q1.reshape((batch_size, 1, sequence_len, 1))
        # wo_a1 = wo_a1.reshape((batch_size, 1, sequence_len, 1))
        # wo_q2 = wo_q2.reshape((batch_size, 1, sequence_len, 1))
        # wo_a2 = wo_a2.reshape((batch_size, 1, sequence_len, 1))
        ...
        len4 = T.sqrt(T.sum(output_drop4 * output_drop4, axis=1))
        #计算向量之间的夹角
        cos12 = T.sum(output_drop1 * output_drop2, axis=1) / (len1 * len2)
        self.cos12 = cos12
        cos34 = T.sum(output_drop3 * output_drop4, axis=1) / (len3 * len4)
        self.cos34 = cos34
        ...
        #Loss损失函数
        diff = T.cast(T.maximum(zero, margin - cos12 + cos34), dtype=theano.config.floatX)
